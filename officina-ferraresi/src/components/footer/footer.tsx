  ...
  return (
    <>
      <footer className="footer p-10">
        <nav>
          <header className="title-footer">CONTATTI</header>
          <span className="footer-span">
            <BiSolidPhoneCall fill="white" /> +3899982052
          </span>
          <span className="footer-span">
            <BiLogoGmail fill="white" />
            officina.ferraresi@gmail.com
          </span>
          <span className="footer-span">
            <GiPositionMarker fill="white" />
            Via mocenighe
          </span>
        </nav>
        <nav>
          <header className="title-footer">ORARI</header>
